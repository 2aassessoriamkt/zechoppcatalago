...
-- === CATEGORIA: CHOPPS ===
('Chopp Brahma', 13.90, 'O clássico número um. Chopp Brahma claro, leve e refrescante, servido em caneca trincando de gelada com colarinho super cremoso.', 'assets/chopp_premium.png', 'chopps', ARRAY[]::TEXT[], true),
('Chopp Pilsen Pantanal', 11.90, 'Direto da torneira! Chopp Pilsen regional leve, suave e estupidamente gelado. Perfeito para o happy hour sob o calor de Novo Progresso.', 'assets/chopp_premium.png', 'chopps', ARRAY[]::TEXT[], true),
...
-- === CATEGORIA: PORÇÕES ===
('Porção de Filé Acebolado', 64.90, 'Tiras macias e suculentas de filé mignon nobre grelhadas em chapa de ferro bem quente, com cebolas douradas na manteiga.', 'assets/porcao_picanha.png', 'petiscos', ARRAY[]::TEXT[], true),
('Porção de Batata Palito', 29.90, 'Uma generosa porção de batatas fritas palito fritas em alta temperatura para garantir maciez interna e casquinha super crocante.', 'assets/porcao_batata.png', 'petiscos', ARRAY[]::TEXT[], true),
('Porção de Calabresa Acebolada', 34.90, 'Linguiça calabresa defumada fatiada de primeira qualidade, salteada na chapa de ferro com bastante cebola em rodelas douradas e salsinha.', 'https://images.unsplash.com/photo-1534939561126-855b8675edd7?auto=format&fit=crop&q=80&w=400', 'petiscos', ARRAY[]::TEXT[], true),
('Porção de Frango a Passarinho', 38.90, 'Tradicionais cortes de frango caipira marinados nas ervas finas, fritos na hora com alho dourado e bastante cheiro-verde picadinho.', 'https://images.unsplash.com/photo-1562967914-608f82629710?auto=format&fit=crop&q=80&w=400', 'petiscos', ARRAY[]::TEXT[], true),
('Porção de Frios Completa', 39.90, 'Ovos de codorna no azeite, azeitonas verdes suculentas, palmito em rodelas, pepino crocante em conserva e cubos de queijo mussarela premium.', 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&q=80&w=400', 'petiscos', ARRAY[]::TEXT[], true),
('Porção de Pururuca', 19.90, 'Pele de porco selecionada, desidratada e pururucada na hora. Leve, aerada, extremamente crocante e sequinha.', 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?auto=format&fit=crop&q=80&w=400', 'petiscos', ARRAY[]::TEXT[], true),
('Porção de Quibe c/ Queijo (8 un)', 27.90, 'Mini quibes artesanais fritos na hora, feitos com carne de primeira moída com hortelã fresca e recheados com mussarela derretida.', 'https://images.unsplash.com/photo-1541532713592-79a0317b6b77?auto=format&fit=crop&q=80&w=400', 'petiscos', ARRAY[]::TEXT[], true),
('Porção de Tilápia Crocante', 48.90, 'Iscas generosas de filé de tilápia fresca, empanadas na farinha panko especial e fritas na hora. Acompanha molho tártaro.', 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?auto=format&fit=crop&q=80&w=400', 'petiscos', ARRAY[]::TEXT[], true),
('Porção de Costelinha de Tambaqui', 52.90, 'As famosas costelinhas de tambaqui da região, cortadas e temperadas no grau, fritas na hora até dourar. Fartas de carne branca e suculenta.', 'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?auto=format&fit=crop&q=80&w=400', 'petiscos', ARRAY[]::TEXT[], true),
('Porção de Filé de Tambaqui', 56.90, 'Filé nobre de tambaqui sem espinhos grelhado na chapa de ferro com ervas finas e manteiga de garrafa.', 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?auto=format&fit=crop&q=80&w=400', 'petiscos', ARRAY[]::TEXT[], true),
('Porção de Costelinha Suína', 49.90, 'Costelinha de porco temperada na cachaça e ervas finas, assada na brasa e finalizada na chapa quente com casquinha dourada.', 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&q=80&w=400', 'petiscos', ARRAY[]::TEXT[], true),
('Porção de Pirarucu', 62.90, 'Lombos suculentos de Pirarucu grelhados com azeite, alcaparras e cebola caramelizada.', 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?auto=format&fit=crop&q=80&w=400', 'petiscos', ARRAY[]::TEXT[], true),
