...
const STATIC_PRODUCTS = [
    // === CATEGORIA: CHOPPS ===
    { id: "chopp-brahma", name: "Chopp Brahma", price: 13.90, description: "O clássico número um. Chopp Brahma claro, leve e refrescante, servido em caneca trincando de gelada com colarinho super cremoso.", image: "assets/13_chopp_brahma.png", category: "chopps", tags: [] },
    { id: "chopp-pantanal", name: "Chopp Pilsen Pantanal", price: 11.90, description: "Direto da torneira! Chopp Pilsen regional leve, suave e estupidamente gelado. Perfeito para o happy hour sob o calor de Novo Progresso.", image: "assets/14_chopp_pilsen_pantanal.png", category: "chopps", tags: [] },
    ...
    // === CATEGORIA: PORÇÕES ===
    { id: "porcao-file-acebolado", name: "Porção de Filé Acebolado", price: 64.90, description: "Tiras macias e suculentas de filé mignon nobre grelhadas em chapa de ferro bem quente, com cebolas douradas na manteiga.", image: "assets/01_porcao_file_acebolado.png", category: "petiscos", tags: [] },
    { id: "porcao-batata-palito", name: "Porção de Batata Palito", price: 29.90, description: "Uma generosa porção de batatas fritas palito fritas em alta temperatura para garantir maciez interna e casquinha super crocante.", image: "assets/02_porcao_batata_palito.png", category: "petiscos", tags: [] },
    { id: "porcao-calabresa-acebolada", name: "Porção de Calabresa Acebolada", price: 34.90, description: "Linguiça calabresa defumada fatiada de primeira qualidade, salteada na chapa de ferro com bastante cebola em rodelas douradas e salsinha.", image: "assets/03_porcao_calabresa_acebolada.png", category: "petiscos", tags: [] },
    { id: "porcao-frango-passarinho", name: "Porção de Frango a Passarinho", price: 38.90, description: "Tradicionais cortes de frango caipira marinados nas ervas finas, fritos na hora com alho dourado e bastante cheiro-verde picadinho.", image: "assets/04_porcao_frango_passarinho.png", category: "petiscos", tags: [] },
    { id: "porcao-frios", name: "Porção de Frios Completa", price: 39.90, description: "Ovos de codorna no azeite, azeitonas verdes suculentas, palmito em rodelas, pepino crocante em conserva e cubos de queijo mussarela premium.", image: "assets/05_porcao_frios.png", category: "petiscos", tags: [] },
    { id: "porcao-pururuca", name: "Porção de Pururuca", price: 19.90, description: "Pele de porco selecionada, desidratada e pururucada na hora. Leve, aerada, extremamente crocante e sequinha.", image: "assets/06_porcao_pururuca.png", category: "petiscos", tags: [] },
    { id: "porcao-quibe-queijo", name: "Porção de Quibe c/ Queijo (8 un)", price: 27.90, description: "Mini quibes artesanais fritos na hora, feitos com carne de primeira moída com hortelã fresca e recheados com mussarela derretida.", image: "assets/07_porcao_quibe_queijo.png", category: "petiscos", tags: [] },
    { id: "porcao-tilapia", name: "Porção de Tilápia Crocante", price: 48.90, description: "Iscas generosas de filé de tilápia fresca, empanadas na farinha panko especial e fritas na hora. Acompanha molho tártaro.", image: "assets/08_porcao_tilapia.png", category: "petiscos", tags: [] },
    { id: "porcao-costelinha-tambaqui", name: "Porção de Costelinha de Tambaqui", price: 52.90, description: "As famosas costelinhas de tambaqui da região, cortadas e temperadas no grau, fritas na hora até dourar. Fartas de carne branca e suculenta.", image: "assets/09_porcao_costelinha_tambaqui.png", category: "petiscos", tags: [] },
    { id: "porcao-file-tambaqui", name: "Porção de Filé de Tambaqui", price: 56.90, description: "Filé nobre de tambaqui sem espinhos grelhado na chapa de ferro com ervas finas e manteiga de garrafa.", image: "assets/10_porcao_file_tambaqui.png", category: "petiscos", tags: [] },
    { id: "porcao-costelinha-suina", name: "Porção de Costelinha Suína", price: 49.90, description: "Costelinha de porco temperada na cachaça e ervas finas, assada na brasa e finalizada na chapa quente com casquinha dourada.", image: "assets/11_porcao_costelinha_suina.png", category: "petiscos", tags: [] },
    { id: "porcao-pirarucu", name: "Porção de Pirarucu", price: 62.90, description: "Lombos suculentos de Pirarucu grelhados com azeite, alcaparras e cebola caramelizada.", image: "assets/12_porcao_pirarucu.png", category: "petiscos", tags: [] },
